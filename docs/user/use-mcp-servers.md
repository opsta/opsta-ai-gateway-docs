...
- Your administrator has registered one or more MCP servers for your project — see
  [MCP servers (admin)](/admin/mcp-servers).
- You have a project API key ([Manage API keys](/user/api-keys)).
:::
...
- [Connect a client](/user/connect-a-client) — the chat API.
- Administrators register servers in [MCP servers](/admin/mcp-servers).
