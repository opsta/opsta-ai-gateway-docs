...
The platform operator sets how long audit entries are kept — see [Audit & compliance](/security/audit-and-compliance).

## Next steps

- [RBAC model](/security/rbac) — the roles whose actions are audited.
- [Audit & compliance](/security/audit-and-compliance) — retention and compliance use.
