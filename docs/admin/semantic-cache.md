...
[budget](/admin/budgets-and-limits). Cached responses are isolated per project — one project's answers are never
...
- [Semantic guard](/admin/semantic-guard) — the same vector approach applied to safety.
- [Budgets & limits](/admin/budgets-and-limits) — see cache savings against spend.
