...
[Key concepts](/overview/concepts) and the [Multi-tenancy model](/overview/multi-tenancy).
...
- [Key concepts](/overview/concepts) — the model these terms describe.
- [Multi-tenancy model](/overview/multi-tenancy) — organizations, projects, groups, users.
